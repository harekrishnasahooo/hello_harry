        ...
        if self.cmd_quest.get()=="Select" or self.txt_answer.get()=="" or self.txt_new_password.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    con.commit()
                    con.close()
                    messagebox.showinfo("Success ","your password has been reset, pls login with new password",parent=self.root2)
                    self.reset()
                    self.root2.destroy()
        ...
        if self.txt_email.get() == "":
            ...
            try:
                ...
                if row == None:
                    ...
                    btn_change_password = Button(self.root2, text="Reset password",command=self.forget_password,bg="green", fg="white",
        ...
        if self.txt_email.get() == "" or self.txt_email_pass_.get() == "":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("SuccessR", "welcome", parent=self.root)
                    con.close()
